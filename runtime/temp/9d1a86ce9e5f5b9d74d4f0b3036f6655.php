<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\www\mlxyadmin\application\advance\view\index\mobile_form.html";i:1509335494;}*/ ?>
<!doctype html>
<html lang="">
<head>
  <meta charset="utf-8">
  ...
  <div id="page-wrapper">
    <div class="form-wrapper">
      <div class="mobile-form-logo-header">
        <a class="logo-wrapper visible-xs clearfix" href="<?php echo url('/Allianz'); ?>">
      ...
      <form class="medical-form  form-horizontal" role="form">
        ...
        <div class="form-section">
          <div class="form-group">
            <label for="" class="col-xs-6 col-sm-4 control-label medical-label">Is't that you?</label>
          ...
          <div class="form-group">
            <label for="other-relation" class="col-xs-5 col-sm-4 control-label medical-label">Relationship with the patient</label>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label for="user-zip" class="col-xs-5 col-sm-4 control-label medical-label"><span class="has-width">Zip code</span></label>
            <div class="col-xs-7 col-sm-8">
              <input type="text" class="form-control" id="zip_code" name="zip_code">
            </div>
          </div>
          <div class="form-group">
            <label for="user-first-phone" class="col-xs-5 col-sm-4 control-label medical-label"><span class="has-width">Preferred phone</span></label>
            <div class="col-xs-7 col-sm-8">
              <input type="text" class="form-control" id="user-first-phone" name="preferred_phone">
            </div>
          </div>
          <div class="form-group">
            <label for="user-second-phone" class="col-xs-5 col-sm-4 control-label medical-label"><span class="has-width">Standby telephone</span></label>
            <div class="col-xs-7 col-sm-8">
              <input type="text" class="form-control" id="user-second-phone" name="standby_phone">
            </div>
          </div>
          <div class="form-group">
            <label for="user-email" class="col-xs-5 col-sm-4 control-label medical-label"><span class="has-width"><span class="little-character">E&#45;mail </span>address</span></label>
            <div class="col-xs-7 col-sm-8">
              <input type="text" class="form-control" id="user-email" name="email">
            </div>
          </div>
          <div class="form-group">
            <label for="user-time" class="col-xs-5 col-sm-6 col-md-5 col-lg-4 control-label medical-label special-label"><div class="time-grid"><span>Easy to answer the phone time</span><span>preferred time</span></div><div>&#40;Multiple choice&#41;</div></label>
        ...
        <div class="form-navigation clearfix">
          <a type="button" class="back-to-home btn btn-navigate pull-left" href="<?php echo url('/Allianz'); ?>">Return</a>
    ...
    <div class="form-feedback-wrapper">
      <div class="form-feedback">
        ...
        <a class="btn form-feedback-btn" href="<?php echo url('/Allianz'); ?>">I know</a>
      </div>
    </div>
    <div class="contract-context">
      <div class="contract-header">
        <span>Authorization agreement</span><span class="contract-close-button"><i class="fa fa-times"></i></span>
      </div>
