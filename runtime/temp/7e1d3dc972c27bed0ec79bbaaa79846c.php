<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\www\mlxyadmin\application\advance\view\index\index.html";i:1508126108;s:58:"D:\www\mlxyadmin\application\advance\view\common\base.html";i:1509175244;s:60:"D:\www\mlxyadmin\application\advance\view\common\header.html";i:1509432974;s:60:"D:\www\mlxyadmin\application\advance\view\common\footer.html";i:1510025047;}*/ ?>
<!doctype html>
<html lang="">
<head>
  <meta charset="utf-8">
  ...
  <div id="page-wrapper">
    ...
    <div class="top-nav clearfix">
      <a class="logo-wrapper clearfix" href="<?php echo url('/Allianz'); ?>">
        <span class="logo1 visible-lg visible-md visible-sm"><img src="<?php echo $static_path; ?>/advance/img/logo.png" alt=""></span>
        <?php if($userid != 0): ?>
        ...
        <?php if($userid != 0): ?>
      <a class="login-wrapper visible-lg visible-md visible-sm" href="<?php echo url('Login/logout'); ?>"><?php echo $minedata['user_name']; ?>,Log out</a>
...
<div class="feature-container clearfix">
      <div class="feature-wrapper">
        ...
        <div class="feature-desc feature-desc-1">
          ...
          <ul>
            <li><a href="<?php echo url('/services/1'); ?>#diagnose"><span class="feature-text">What is GEMO?<span class="feature-icon"><i class="fa fa-angle-right"></i></span></span></a></li>
        ...
        <div class="feature-desc feature-desc-2">
          <div class="feature-desc-inner-wrapper">
          <h3><span>Diabetes Care Program</span></h3>
          <ul>
            <li><a href="<?php echo url('/services/2'); ?>#pressure"><span class="feature-text"><span class="special-text">Diabetes Care Program</span><span class="feature-icon"><i class="fa fa-angle-right"></i></span></span></a></li>
          </ul>
        </div>
        </div>
      </div>
...
<div class="bottom-nav-wrapper clearfix">
      <ul class="bottom-nav">
        ...
        <li><a href="<?php echo url('/services/2'); ?>#Cpmao">Diabetes Care Program</a></li>
